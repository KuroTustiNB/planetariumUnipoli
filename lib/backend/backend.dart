...
import 'schema/stars_record.dart';
...
export 'schema/stars_record.dart';
...
/// Functions to query StarsRecords (as a Stream and as a Future).
Stream<List<StarsRecord>> queryStarsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      StarsRecord.collection,
...
Future<List<StarsRecord>> queryStarsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<StarsRecord>> queryStarsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
